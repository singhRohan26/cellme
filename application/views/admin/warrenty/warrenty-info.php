                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <div class="page-title-right">
                                <a href="<?php echo base_url('admin/warrenty-repair'); ?>" class="btn btn-primary">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                                 ...
                                 <div class="col-lg-12 col-xl-12">
                                    <div class="card">
                                        <div class="card-block">
                                                ...
                                                <div class="col-3">                                                
                                                    <?php if (!empty($warrentdetails['full_name'])) {
                                                        echo $warrentdetails['full_name'];
                                                    } ?>
                                                </div>
                                                <div class="col-3">                                                
                                                    <label>Email Id</label>
                                                </div>
                                                <div><?php  if (!empty($warrentdetails['email'])) {
                                                    echo $warrentdetails['email'];
                                                }?>
                                            </div>
                                           ...
                                           <div class="col-3">                                                
                                              <?php if (!empty($warrentdetails['country_code'] || $warrentdetails['mobile_no'] )) {
                                                echo $warrentdetails['country_code'] . $warrentdetails['mobile_no'];
                                            } ?>
                                        </div>
                                        <div class="col-3">                          
                                           <label>Address</label>
                                       ...
                                       <div class="col-3">                                                
                                         <?php if (!empty($warrentdetails['address'])) {
                                            echo $warrentdetails['address'];
                                        } ?>
                                    </div> 
                                       <div class="col-3">                          
                                           <label>Warrenty Repair Status</label>
                                       </div>
                                       <div class="col-3">                                                
                                         <?php if (!empty($warrentdetails['order_status'])) {
                                            echo $warrentdetails['order_status'];
                                        } ?>
                                    </div>
