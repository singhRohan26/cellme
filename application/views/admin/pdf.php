...
<tr>
    ...
    <th  style="font-size: 10px;text-align: left"><span>Cosmetic Function</span></th>
    <th colspan="2"  style="font-size: 10px;text-align: right"><span></span></th>
  </tr> 
<tr>
    <td  style="font-size: 10px;text-align: left"><span>Front Display/Screen</span></td>
    <td colspan="2"  style="font-size: 10px;text-align: right"><span><?php echo $cosmeticTesting['display'] ?></span></td>
  </tr> 
<tr>
    <td  style="font-size: 10px;text-align: left"><span>All Sides and Corners</span></td>
    <td colspan="2"  style="font-size: 10px;text-align: right"><span><?php echo $cosmeticTesting['all_sides'] ?></span></td>
  </tr> 
<tr>
    <td  style="font-size: 10px;text-align: left"><span>Buttons</span></td>
    <td colspan="2"  style="font-size: 10px;text-align: right"><span><?php echo $cosmeticTesting['buttons'] ?></span></td>
  </tr> 
<tr>
    <td  style="font-size: 10px;text-align: left"><span>Rear cover/Back</span></td>
    <td colspan="2"  style="font-size: 10px;text-align: right"><span><?php echo $cosmeticTesting['rear_back_cover'] ?></span></td>
  </tr> 
<tr>
    <td  style="font-size: 10px;text-align: left"><span>Images has shadow/burn or missing 
pixels/ bleed ?</span></td>
    <td colspan="2"  style="font-size: 10px;text-align: right"><span><?php echo $cosmeticTesting['image_shaddow'] ?></span></td>
  </tr> 
   
 <br>
</table>
        
        <P style="text-align: center">Overall Grade <b><?php echo $grade['grade'] ?></b></P>
